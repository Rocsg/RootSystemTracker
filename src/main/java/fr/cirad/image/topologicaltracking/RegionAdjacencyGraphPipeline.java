...
import fr.cirad.image.rootsystemtracker.PipelineParamHandler;
...
//		for(CC cc:tabDel)cc.lightOffLateralRoot();
	...
	public static boolean buildAndProcessGraphStraight(ImagePlus imgDatesTmp,String outputDataDir,PipelineParamHandler pph) {
		double ray=5;
		int thickness=5;
