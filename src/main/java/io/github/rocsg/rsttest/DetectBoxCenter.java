    ...
    public static void main(String[] args) {
        ...
        for (int nb = 3; nb < 30; nb++) {
            ...
            for (int n = 1; n < imgStack.getStackSize(); n++) {
                ...
                //img.show();
                ImagePlus img2 = MorphoUtils.dilationLine2D(img, 2, true);
                img2 = MorphoUtils.erosionLine2D(img2, 15, true);//img2.show();VitimageUtils.waitFor(5000);
                img2 = MorphoUtils.dilationLine2D(img2, 2, false);
                img2 = MorphoUtils.erosionLine2D(img2, 15, false);
                img2 = MorphoUtils.erosionCircle2D(img2, 3);
